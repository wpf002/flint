 ...
 *     ("how are you?" is small talk, not a status request).
 ...
 * paragraphs no longer claim a weekly retrain, and greetings, past mistakes and
 * "I don't care" got their own rules. v2 is live, and a new name would not have
 * reached Will without a config change.
 *
